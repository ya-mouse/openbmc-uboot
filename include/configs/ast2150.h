...
#define	CONFIG_BOOTARGS 	"root=/dev/ram0 rw initrd=0x42600000,0xd00000 ramdisk_size=13312 mem=112M console=ttyS0,38400n8 ethaddr=aa:bb:cc:ee:dd:01 eth1addr=aa:bb:cc:ee:dd:02 debug verbose panic=30"
...
#define CONFIG_MACH_TYPE	0x0384
...
#define PHYS_SDRAM_1_SIZE	0x8000000  	/* 128 MB - 8 MB VRAM */
#define CONFIG_SYS_MEM_TOP_HIDE	0x800000
...
#define CONFIG_SYS_NS16550_CLK		24000000 /* 1843200 */
